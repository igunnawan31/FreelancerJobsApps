    ...
    <div class="p-6 space-y-6">
        ...
        <div class="flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-white/20">
            <div class="flex items-center gap-4">
                <a href="{{ route('profiles.index') }}" class="p-2 hover:bg-gray-100 rounded-full transition">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <form id="userForm" action="{{ route('profiles.update') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="pt-6 border-t border-gray-50 flex gap-3">
                    ...
                    <a href="{{ route('profiles.index') }}" class="px-8 py-3 bg-gray-100 text-gray-600 font-semibold rounded-xl hover:bg-gray-200 transition text-center">
                        Cancel
                    </a>
                </div>
            </form>
